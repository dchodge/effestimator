...
ggsave(file = paste0("incidence_pla_", name, ".pdf"), g1)
...
ggsave(file = paste0("exp_", name, ".pdf"), g2)
...
ggsave(file = paste0("er2_", name, ".pdf"), g3)
...
ggsave(file = paste0("er3_", name, ".pdf"), g4)
