...
lower_bounds_no_boundary_ms <- c(1000000, 1000000, 1000000)
...
fitted_functions(data_oa_GSK, "oa_GSK_nobound", lower_bounds_no_boundary_ms)
fitted_functions(data_oa_pfizer, "oa_pfizer_nobound", lower_bounds_no_boundary_ms)
fitted_functions(data_oa_moderna, "oa_moderna_nobound", lower_bounds_no_boundary_ms)
...
modelname <- "oa_GSK_moderna_nobound"
...
dplyr::bind_rows(dat_exp, dat_er2, dat_er3) |> 
  ...
  ggplot(aes(x = t, y = waning, group = .draw)) + 
  geom_line() + 
  facet_grid(fn ~ ., scales = "free")
